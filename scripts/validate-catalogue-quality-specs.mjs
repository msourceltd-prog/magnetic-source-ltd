...
const expected = { "baby-family": 20, "diy-hardware": 28, "electrical-accessories": 20, "gifts-gadgets": 22, "home-utility": 30, "household-cleaning": 29, "kitchen-dining": 28, "medical-first-aid": 22, "party-events": 22, "personal-care": 28, pets: 24, seasonal: 22, stationery: 26 };
...
if (missing.length || duplicateNames.length || unexpected.length || specs.length !== 321) {
