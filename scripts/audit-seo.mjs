...
if ((sitemap.match(/<loc>/g) || []).length !== 335) failures.push("sitemap URL count is not 335");
...
console.log(`SEO audit passed for ${allPaths.length} pre-rendered public pages, 335 sitemap URLs, root robots.txt, and homepage Organization schema.`);
