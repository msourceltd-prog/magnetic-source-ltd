...
- [ ] Publish the selected secure server-hosted version and connect `magneticsource.uk` through the built-in domain settings so the live Contact form can run its Gmail delivery backend.
