...
- [ ] Remove the Contact form’s browser-autofill-prone hidden-field check after the owner’s screenshot confirmed that it blocks genuine submissions before they reach the secure Cloudflare email endpoint; retain a browser-safe direct delivery path and verify a final live email receipt.
