...
- [ ] Extend the existing Admin Login so authorized users can manage the three rotating homepage hero images, preserve the four-second automatic rotation, and choose which catalogue products appear in the Best Sellers and New Arrivals homepage sections without changing public-site code.
