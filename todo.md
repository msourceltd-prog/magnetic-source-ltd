...
- [ ] Replace the ambiguous combined Best Seller/New Arrival product toggles with two clearly separated client workflows, each with plain-language descriptions and explicit Add or Remove actions, while preserving the homepage collection data.
